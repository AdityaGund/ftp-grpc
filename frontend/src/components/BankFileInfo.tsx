...
export function BankFileInfo({ files, loading, onRefresh, username }: BankFileInfoProps) {
          ...
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="flex items-center gap-2 text-xl">
                ...
                <span>File Transfer History</span>
              </CardTitle>
              <CardDescription className="text-base">
                View all file transfers for bank: {username}
              </CardDescription>
            </div>
            <Button 
              onClick={onRefresh} 
          ...
          {loading && files.length === 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-muted-foreground">
                No file transfer history available for this bank.
              </p>
            </div>
          ) : (
